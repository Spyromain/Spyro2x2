...
void Sp2x2LogicSpyro(void)
{
    ...
    Sp2x2Swap(&sp2_calculation_results, &sp2x2_calculation_results, sizeof sp2_calculation_results);
    Sp2x2Swap(&sp2_level_timer, &sp2x2_level_timer, sizeof sp2_level_timer);
